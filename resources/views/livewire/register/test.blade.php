<div>
            ...
            <div class="container w-full items-center px-5 py-4 mt-2 text-blueGray-500 lg:px-20">
                <div class="w-auto p-2 mx-auto my-6 bg-white border border-solid border-blueGray-300 rounded-lg shadow-xl lg:w-1/2">
                    <div class="flex flex-wrap justify-center items-center whitespace-nowrap mt-2">
                        <div class="p-3 text-sm font-semibold border border-solid border-blueGray-100 uppercase mx-auto">
                        ...
                        <div class="p-3 text-sm font-semibold border border-solid border-blueGray-300 uppercase mx-auto">
    ...
    <div class="overflow-hidden flex justify-center min-h-screen">
        <div class="overflow-x-auto">
            <table wire:loading.class="hidden" class="table table-index w-1/2">
                <thead>
                <tr>
                    <th class="min-w-48">
                                        ...
                                        <div class="relative inline-flex">
                                            ...
                                            <div class="relative inline-flex align-middle w-full">
                                                ...
                                                <div class="hidden bg-orange-500 w-full text-base z-50 float-left list-none text-left rounded shadow-lg" id="absent-dropdown-{{ $child['child_id'] }}">
                                                    <a href="#" wire:click.prevent="markAbsent({{$child['child_id']}}, '{{$child['morning']}}', '{{ 'M' }}')" onclick="openDropdown(event,'absent-dropdown-{{ $child['child_id'] }}')"
                                                    ...
                                                    <a href="#" wire:click.prevent="markAbsent({{$child['child_id']}}, '{{$child['morning']}}', '{{ 'S' }}')" onclick="openDropdown(event,'absent-dropdown-{{ $child['child_id'] }}')"
                                                       class="text-base py-2 px-4 block w-full whitespace-no-wrap bg-transparent border border-solid border-blueGray-500 hover:bg-red-500 text-white font-semibold">
                                                        Sick
                                                    </a>
                                                    <div class="h-0 my-1 border border-solid border-t-0 border-blueGray-800 opacity-25"></div>
                                    ...
                                    @if(is_null($child['afternoon_present']) && is_null($child['afternoon_absent']))
                                        <div class="relative inline-flex">
                                            ...
                                            <div class="relative inline-flex align-middle w-full">
                                                ...
                                                <div class="hidden bg-orange-500 w-full text-base z-50 float-left list-none text-left rounded shadow-lg" id="absent-dropdown-{{ $child['child_id'] }}">
                                                    <a href="#" wire:click.prevent="markAbsent({{$child['child_id']}}, '{{$child['afternoon']}}', '{{ 'M' }}')" onclick="openDropdown(event,'absent-dropdown-{{ $child['child_id'] }}')"
                                                       class="text-base py-2 px-4 block w-full whitespace-no-wrap bg-transparent border border-solid border-blueGray-500 hover:bg-red-500 text-white font-semibold" >
                                                        Medical
                                                    </a>
                                                    <div class="h-0 my-1 border border-solid border-t-0 border-blueGray-800 opacity-25"></div>
                                                    <a href="#" wire:click.prevent="markAbsent({{$child['child_id']}}, '{{$child['afternoon']}}', '{{ 'S' }}')" onclick="openDropdown(event,'absent-dropdown-{{ $child['child_id'] }}')"
                                                       class="text-base py-2 px-4 block w-full whitespace-no-wrap bg-transparent border border-solid border-blueGray-500 hover:bg-red-500 text-white font-semibold">
                                                        Sick
                                                    </a>
                                                    <div class="h-0 my-1 border border-solid border-t-0 border-blueGray-800 opacity-25"></div>
